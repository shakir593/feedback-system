    ...
    <div class="row gy-4">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method = "post" action = "{{ route('product-category.update',$product_category->id) }}">
                        <div class="row gy-3">
                            @csrf
                            <div class="col-6">
                                <label class="form-label">Name</label>
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value = "{{ $product_category->name }}">
                                @error('title')
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-switch switch-success d-flex align-items-center gap-3">
                                    <input class="form-check-input @error('status') is-invalid @enderror" type="checkbox" name = "status" role="switch" value = "1" id="horizontal3" {{ $product_category->status == 1 ? 'checked' : '' }}>
